...
double init(bool load_checkpoint, double start_time)
{
...
SWAReport *master(CharArray *sequence1, CharArray *sequence2, bool load_checkpoint, double start_time, double *accumulated_time_checkpoint)
{
    seq1 = sequence1;
    seq2 = sequence2;

    *accumulated_time_checkpoint = init(load_checkpoint, start_time);
